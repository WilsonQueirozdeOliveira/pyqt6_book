...
#class JanelaPrincipal(QMainWindow):
    ...
    ####################################
        ...
        # peso da correia [%]
        layout_peso_da_correia = QHBoxLayout()
        peso_da_correia = QLabel('Peso da correia [Kg]:')
        layout_peso_da_correia.addWidget(peso_da_correia)
        self.input_peso_da_correia = QLineEdit(self)
        self.input_peso_da_correia.setPlaceholderText('0.0 [Kg]')
        layout_peso_da_correia.addWidget(self.input_peso_da_correia)
        self.input_peso_da_correia.textChanged.connect(self.calcular_transporte)
        layout_peso_da_correia.addStretch()
        layout_coluna_1_tab_calculos_de_transporte.addLayout(layout_peso_da_correia)

        # Carga máxima menos peso da correia [kg]
        self.carga_pos_peso_correia = QLabel('Carga máxima após peso da correia [kg]: ')
        layout_coluna_1_tab_calculos_de_transporte.addWidget(self.carga_pos_peso_correia)
    ...
    def calcular_transporte(self):
        ...
        carga_tangente = 0
        peso_da_correia = 0
        #carga_maxima_apos_peso_da_correia = 0
        ...
        # peso da correia
        if self.input_peso_da_correia.text():
            try:
                if isinstance(float(self.input_peso_da_correia.text()),float):
                        peso_da_correia = float(self.input_peso_da_correia.text())
                        print('input peso da correia')                       
            except:
                print('erro input peso da correia')
            
        if carga_tangente and peso_da_correia:
            carga_maxima_apos_peso_da_correia = carga_tangente - peso_da_correia
            self.carga_pos_peso_correia.setText(
                'Carga máxima após peso da correia [kg]: '
                +str(carga_maxima_apos_peso_da_correia)+'[kg]')
